...
type TestimoniServiceType = {
  getAllTestimoni: () => Promise<Testimoni[]>;
  getTestimoniById: (id: number) => Promise<Testimoni>;
  createTestimoni: (testimoniData: any, photoFile: File | null) => Promise<Testimoni>;
  updateTestimoni: (id: number, testimoniData: any, photoFile: File | null) => Promise<Testimoni>;
  deleteTestimoni: (id: number) => Promise<void>;
  updateTestimoniStatus: (id: number, status: 'active' | 'inactive') => Promise<void>;
};

export const TestimoniService: TestimoniServiceType = {
