...
// Define interfaces for menu items and badges
                  ...
                  <TooltipTrigger asChild>
                    <button 
                      ...
                      onClick={() => {
                        ...
                        } else if (item.items && item.items.length > 0 && item.items[0].url) {
                        ...
                        <div className="mt-1 space-y-1">
                          {item.items.map((subItem) => (
                            ...
                            >
                              • {subItem.title}
                              {subItem.isActive && (
                                <span className="inline-block w-1.5 h-1.5 rounded-full bg-primary ml-1.5 animate-pulse"></span>
                              )}
                              {subItem.badge && (
                ...
                {!item.items || item.items.length === 0 ? (
                  ...
                  >
                    ...
                    <span className="flex-1 text-left whitespace-nowrap">
                      {item.title}
                      {item.isActive && (
                        <span className="inline-block w-1.5 h-1.5 rounded-full bg-primary ml-2 animate-pulse"></span>
                      )}
                    </span>
                  </a>
                ) : (
