...
// Announcement Service
export const AnnouncementService = {  // Get all announcements (admin)
    ...
    try {
      ...
      try {
        ...
        if (Array.isArray(response)) {
          ...
          console.warn('Admin endpoint returned invalid data format:', response);
          throw new Error('Invalid data format from admin endpoint');
        }
      } catch (adminError) {
        ...
        try {
          ...
          if (Array.isArray(publicResponse)) {
            ...
            console.warn('Public endpoint returned invalid data format:', publicResponse);
          ...
          // If both endpoints fail, return sample data for testing UI
          console.log('Returning sample data for debugging');
          return [
            {
              id: 1,
              title: 'Pengumuman Beasiswa 2025',
              content: 'Pendaftaran beasiswa tahun 2025 telah dibuka. Silahkan daftar sekarang!',
            ...
            {
              id: 2,
              title: 'Info Pembaruan Sistem',
              content: 'Sistem Bersekolah akan diperbarui pada tanggal 25 Juni 2025',
